...
int add_label(t_prog *tmp, t_core *core, int poslab)
{
    ...
    if (tmp->to_write[poslab] != INT_MIN) return 1;
    my_putstr("Error Label not found"); exit(84);
}
